...
<body>
    ...
    <div class="">
        ...
        <<nav class="navbar navbar-expand-sm navbar-dark fixed-top">
            ...
            <div class="w-full bg-green-300 overflow-hidden mt-10">
                <div class="w-full text-center py-2">
                    <div class="marquee flex items-center space-x-4">
                        <span class="inline-block py-1 uppercase">!! WELLCOME!! CHÀO MỪNG BẠN VỚI TRANG ĐẶT
                            {{ $data->tensan }} !! WELLCOME!!</span>
        ...
        <a class="next" onclick="plusSlides(1)">&#10095;</a>
                ...
                <div class="w-6/12">
                    ...
                    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                        <div class="mb-4 flex text-center">
                            <label class=" w-full text-base text-gray-700  font-bold mb-2  text-3xl text-center">Tên
                                sân: {{ $data->tensan }}</label>
                        </div>
                        <div class="mb-4 flex pt-4">
                            <label class=" w-full text-base text-gray-700  font-bold mb-2 text-3xl text-center ">Địa
                                chỉ: {{ $data->diachi }}</label>
                        </div>
                        <div class="mb-4 flex pt-4">
                            <label class=" w-full text-base text-gray-700  font-bold mb-2 text-3xl text-center ">SDT:
                                {{ $data->sdt }}</label>
                        </div>
            ...
            <div class="mx-auto w-8/12 mt-5 mb-5  ">
                ...
                <div class="flex items-center space-x-4 mx-auto justify-center mb-6">
                    <form action="{{ route('admin.datsanPost') }}" method="POST">
                    ...
                    <form action="{{ route('admin.datsanPost') }}" method="POST">
                        <input type="hidden" name="day"
                            value="{{ date('d-m-Y', strtotime($day . ' +1 day')) }}">
                        <input type="hidden" name="id" value="{{ $data->id }}">
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md"> <i
                                    ...
                                    <tr class="text-center bg-gray-200 border-2 border-black">
                                        ...
                                        @foreach ($datasan7 as $keysan)
                                            ...
                                            @foreach ($datsan as $ds)
                                                @if ($ds->khunggio == $key->khunggio && $ds->idsanbong == $keysan->id)
                                                    <td class="border-2 border-black p-2 text-center bg-red-500">
                                                        <div class="text-white mx-auto"> {{ $key->giatien }} $
                                                        </div>

                                                        <div
                                                            class="text-center  w-full h-full font-bold text-white">
                                                            Đã Đặt
                                                        </div>
                                                        <?php
                                                        $kt = 1;
